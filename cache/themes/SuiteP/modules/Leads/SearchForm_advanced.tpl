...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='citizen_identification_advanced'>{sugar_translate label='LBL_CITIZEN_IDENTIFICATION' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.citizen_identification_advanced.value) <= 0}
{assign var="value" value=$fields.citizen_identification_advanced.default_value }
{else}
{assign var="value" value=$fields.citizen_identification_advanced.value }
{/if}
<input type='text' name='{$fields.citizen_identification_advanced.name}'
    id='{$fields.citizen_identification_advanced.name}' size='30'
    maxlength='255'        value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_number_primary_advanced'>{sugar_translate label='LBL_PHONE_NUMBER_PRIMARY' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.phone_number_primary_advanced.value) <= 0}
{assign var="value" value=$fields.phone_number_primary_advanced.default_value }
{else}
{assign var="value" value=$fields.phone_number_primary_advanced.value }
{/if}
<input type='text' name='{$fields.phone_number_primary_advanced.name}'
    id='{$fields.phone_number_primary_advanced.name}' size='30'
    maxlength='255'        value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='card_bark_type_advanced'>{sugar_translate label='LBL_TYPE_CARD_BANK' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='card_bark_type_advanced' name='card_bark_type_advanced[]' options=$fields.card_bark_type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.card_bark_type_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='bank_advanced'>{sugar_translate label='LBL_BANK' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='bank_advanced' name='bank_advanced[]' options=$fields.bank_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.bank_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='sale_stage_advanced'>{sugar_translate label='LBL_SALE_STAGE' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='sale_stage_advanced' name='sale_stage_advanced[]' options=$fields.sale_stage_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.sale_stage_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='lead_status_advanced'>{sugar_translate label='LBL_LEAD_STATUS' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='lead_status_advanced' name='lead_status_advanced[]' options=$fields.lead_status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_status_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'>{sugar_translate label='LBL_CARD_NUMBER' module='Leads'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.email_advanced.name}'
    id='{$fields.email_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='data_sources_advanced'>{sugar_translate label='LBL_DATA_SOURCES' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='data_sources_advanced' name='data_sources_advanced[]' options=$fields.data_sources_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.data_sources_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
