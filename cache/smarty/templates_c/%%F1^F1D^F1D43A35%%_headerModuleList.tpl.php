...
<?php $this->_smarty_vars['capture']['moduleTabId'] = ob_get_contents();  $this->assign('moduleTabId', ob_get_contents());ob_end_clean(); ?>
                                <?php if ($this->_tpl_vars['module'] == 'Leads'): ?>
                                    <a href="http://cas.tranthu.vn/index.php?action=index&module=Leads&searchFormTab=advanced_search&query=true&clear_query=true">Leads</a>
                                <?php else: ?>
...
" class="dropdown-toggle grouptab"
    ...
    foreach ($_from as $this->_tpl_vars['modulekey'] => $this->_tpl_vars['module']):
?>
                                    <?php if ($this->_tpl_vars['module'] == 'Leads' || $this->_tpl_vars['module'] == "Đầu mối"): ?>
                                        <li>
