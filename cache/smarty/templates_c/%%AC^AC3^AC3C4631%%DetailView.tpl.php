<?php /* Smarty version 2.6.33, created on 2023-03-25 14:46:39
         compiled from cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 106, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 99, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 272, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 272, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/SecurityGroups/DetailView.tpl', 272, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='SecurityGroups'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='SecurityGroups'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='SecurityGroups'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_OVERVIEW','module' => 'SecurityGroups'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'SecurityGroups'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'SecurityGroups'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="noninheritable">
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="bool" field="noninheritable" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['noninheritable']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['noninheritable']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['noninheritable']['name']; ?>
" value="$fields.noninheritable.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
