<?php
    ...
    class LeadsViewMay_post extends ViewList
    {
        ...
        public function _getModuleTitleParams($show_help = true)
        {
            ...
            $params[] = $GLOBALS['app_strings']['LBL_MAY_POST'];
            return $params;
        }
        ...
        public function preDisplay()
        {
            ...
            echo '<script type="text/javascript" src="custom/modules/Leads/js/may_post.js"></script>';
            parent::preDisplay();
